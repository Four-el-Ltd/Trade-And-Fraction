...
import com.taf.Tags;
import com.taf.registry.MainRegistry;
...
@Mod(modid = Taf.MODID, name = Taf.NAME, version = Tags.VERSION, dependencies = "required-after:hbm")
public class Taf {
    ...
    @SidedProxy(clientSide = "com.taf.main.ClientProxy", serverSide = "com.taf.main.CommonProxy")
